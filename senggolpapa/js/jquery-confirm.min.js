!function(i) {
    "function" == typeof define && define.amd ? define(["jquery"], i) : "object" == typeof module && module.exports ? module.exports = function(t, n) {
    ...
    r.fn.confirm = function(s, t) {
        ...
        r(this).each(function() {
            var e = r(this);
            e.attr("jc-attached") ? console.warn("jConfirm has already been attached to this element ", e[0]) : (e.on("click", function(t) {
                t.preventDefault();
                var n, i, o = r.extend({}, s);
                e.attr("data-title") && (o.title = e.attr("data-title")),
                e.attr("data-content") && (o.content = e.attr("data-content")),
                void 0 === o.buttons && (o.buttons = {}),
                (o.$target = e).attr("href") && 0 === Object.keys(o.buttons).length && (n = r.extend(!0, {}, l.jconfirm.pluginDefaults.defaultButtons, (l.jconfirm.defaults || {}).defaultButtons || {}),
                i = Object.keys(n)[0],
                o.buttons = n,
    ...
    r.confirm = function(t, n) {
        ...
        var i, o = !(!1 === t.buttons);
        return "object" != typeof t.buttons && (t.buttons = {}),
        0 === Object.keys(t.buttons).length && o && (i = r.extend(!0, {}, l.jconfirm.pluginDefaults.defaultButtons, (l.jconfirm.defaults || {}).defaultButtons || {}),
        t.buttons = i),
        l.jconfirm(t)
    }
    ,
    r.alert = function(t, n) {
        ...
        var i, o, e = !(!1 === t.buttons);
        return "object" != typeof t.buttons && (t.buttons = {}),
        0 === Object.keys(t.buttons).length && e && (i = r.extend(!0, {}, l.jconfirm.pluginDefaults.defaultButtons, (l.jconfirm.defaults || {}).defaultButtons || {}),
        o = Object.keys(i)[0],
        t.buttons[o] = i[o]),
        l.jconfirm(t)
    }
    ...
    l.jconfirm = function(t) {
        ...
        return l.jconfirm.instances.push(i),
        i
    }
    ,
    l.Jconfirm = function(t) {
    ...
    l.Jconfirm.prototype = {
        ...
        _buildHTML: function() {
            ...
            this.containerFluid ? n.find(".jc-bs3-container").addClass(this.bootstrapClasses.containerFluid) : n.find(".jc-bs3-container").addClass(this.bootstrapClasses.container)) : n.find(".jconfirm-box").css("width", this.boxWidth),
            ...
            r.when(this._contentReady, this._modalReady).then(function() {
            ...
            "none" === this.animation && (this.animationSpeed = 1,
        ...
        _parseAnimation: function(t, n) {
            ...
            return "o" === n ? this.animationParsed = e : this.closeAnimationParsed = e,
            e
        },
        ...
        setColumnClass: function(t) {
            this.useBootstrap ? (this.columnClass = t || this.columnClass,
            this._parseColumnClass(this.columnClass),
        ...
        initDraggable: function() {
            ...
            this.resetDrag(),
            this.draggable && (i.on("mousedown", function(t) {
            ...
            r(window).on("mousemove." + this._id, function(t) {
                n.isDrag && (n.movingX = t.clientX - n.mouseX + n.initialX,
        ...
        setDrag: function() {
            var t, n, i, o, e, s, a;
            this.draggable && (this.alignMiddle = !1,
            t = this.$jconfirmBox.outerWidth(),
            n = this.$jconfirmBox.outerHeight(),
            i = r(window).width(),
            o = r(window).height(),
            (e = this).movingX % 1 != 0 && e.movingY % 1 != 0 || (e.dragWindowBorder && (s = i / 2 - t / 2,
            a = o / 2 - n / 2,
            a -= e.dragWindowGap,
        ...
        _watchContent: function() {
            ...
            this._timer = setInterval(function() {
                var t, n;
                i.smoothContent && ((t = i.$content.outerHeight() || 0) !== o && (o = t),
                n = r(window).height(),
        ...
        hiLightModal: function() {
            var t, n = this;
            this._hilightAnimating || (n.$body.addClass("hilight"),
        ...
        _bindEvents: function() {
            ...
            this.$scrollPane.click(function(t) {
                var n, i, o, e;
                s.boxClicked || (o = n = !1,
                o = "string" == typeof (e = "function" == typeof s.backgroundDismiss ? s.backgroundDismiss() : s.backgroundDismiss) && void 0 !== s.buttons[e] ? (n = e,
                !1) : void 0 === e || !0 == !!e,
        ...
        _setButtons: function() {
            ...
            r.each(this.buttons, function(i, t) {
                o += 1,
                "function" == typeof t && (s.buttons[i] = t = {
                    action: t
                }),
                ...
                var n = r('<button type="button" class="btn"></button>').html(s.buttons[i].text).addClass(s.buttons[i].btnClass).prop("disabled", s.buttons[i].isDisabled).css("display", s.buttons[i].isHidden ? "none" : "").click(function(t) {
                    t.preventDefault();
                ...
                s.buttons[i].disable = function() {
                    s.buttons[i].isDisabled = !0,
                    n.prop("disabled", !0)
                }
                ,
                s.buttons[i].enable = function() {
                    s.buttons[i].isDisabled = !1,
                    n.prop("disabled", !1)
                }
                ,
                s.buttons[i].show = function() {
                    s.buttons[i].isHidden = !1,
                    n.css("display", "")
                }
                ,
                s.buttons[i].hide = function() {
                    s.buttons[i].isHidden = !0,
                    n.css("display", "none")
                }
                ,
                s["$_" + i] = s["$$" + i] = n,
            ...
            this.closeIcon ? (this.closeIconClass && (t = '<i class="' + this.closeIconClass + '"></i>',
            this.$closeIcon.html(t)),
            this.$closeIcon.click(function(t) {
                t.preventDefault();
                var n, i = !1, o = !1, e = "function" == typeof s.closeIcon ? s.closeIcon() : s.closeIcon;
                o = "string" == typeof e && void 0 !== s.buttons[e] ? (i = e,
                !1) : void 0 === e || !0 == !!e,
                i && (o = void 0 === (n = s.buttons[i].action.apply(s)) || !!n),
                o && s.close()
            }),
        ...
        setTitle: function(t, n) {
            var i;
            n = n || !1,
            void 0 !== t && ("string" == typeof t ? this.title = t : "function" == typeof t ? ("function" == typeof t.promise && console.error("Promise was returned from title function, this is not supported."),
            i = t(),
            this.title = "string" == typeof i && i) : this.title = !1),
        ...
        setIcon: function(t, n) {
            var i;
            n = n || !1,
            void 0 !== t && ("string" == typeof t ? this.icon = t : "function" == typeof t ? (i = t(),
            this.icon = "string" == typeof i && i) : this.icon = !1),
        ...
        setContent: function(t, n) {
            ...
            this.isAjaxLoading && !n || (this.$content.html(""),
        ...
        _parseContent: function() {
            var t, n, o = this, i = "&nbsp;";
            "function" == typeof this.content && ("string" == typeof (t = this.content.apply(this)) ? this.content = t : ("object" == typeof t && "function" == typeof t.always && (this.isAjax = !0,
            ...
            t.always(function(t, n, i) {
                ...
                "function" == typeof o.contentLoaded && o.contentLoaded(t, n, i)
            })),
            this.content = i)),
            "string" == typeof this.content && "url:" === this.content.substr(0, 4).toLowerCase() && (this.isAjax = !0,
            this.isAjaxLoading = !0,
            n = this.content.substring(4, this.content.length),
            r.get(n).done(function(t) {
        ...
        reactOnKey: function(t) {
            ...
            if (this.$content.find(":input").is(":focus") && /13|32/.test(o))
                return !1;
            var e, s = this._getKey(o);
            "esc" === s && this.escapeKey && (!0 === this.escapeKey ? this.$scrollPane.trigger("click") : "string" != typeof this.escapeKey && "function" != typeof this.escapeKey || (e = "function" == typeof this.escapeKey ? this.escapeKey() : this.escapeKey) && (void 0 === this.buttons[e] ? console.warn("Invalid escapeKey, no buttons found with key " + e) : this["$_" + e].trigger("click"))),
        ...
        close: function(t) {
            var a = this;
            return "function" == typeof this.onClose && this.onClose(t),
            this._unwatchContent(),
            r(window).unbind("resize." + this._id),
            r(window).unbind("keyup." + this._id),
            r(window).unbind("jcKeyDown." + this._id),
            this.draggable && (r(window).unbind("mousemove." + this._id),
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    ...
                    for (var t, n, i, o, e, s = l.jconfirm.instances.length - 1; 0 <= s; s--)
                        l.jconfirm.instances[s]._id === a._id && l.jconfirm.instances.splice(s, 1);
                    l.jconfirm.instances.length || a.scrollToPreviousElement && l.jconfirm.lastFocused && l.jconfirm.lastFocused.length && r.contains(document, l.jconfirm.lastFocused[0]) && (t = l.jconfirm.lastFocused,
                    a.scrollToPreviousElementAnimate ? (n = r(window).scrollTop(),
                    i = l.jconfirm.lastFocused.offset().top,
                    o = r(window).height(),
                    n < i && i < n + o ? t.focus() : (e = i - Math.round(o / 3),
                    r("html, body").animate({
                        scrollTop: e
                    }, a.animationSpeed, "swing", function() {
                        t.focus()
                    }))) : t.focus(),
        ...
        open: function() {
            return !this.isOpen() && (this._buildHTML(),
            this._bindEvents(),
            this._open(),
            !0)
        },
        setStartingPoint: function() {
            ...
            var s = n.left + o
              , a = r(window).height() / 2
              , c = r(window).width() / 2;
            if (e -= a - this.$jconfirmBox.outerHeight() / 2,
