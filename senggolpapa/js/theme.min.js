        ...
        stickyNavbar: function() {
            ...
            if (null != t) {
                ...
                window.addEventListener("scroll", function(e) {
                    400 < e.currentTarget.pageYOffset ? (t.classList.contains("navbar-transparent") || (document.body.style.paddingTop = r + "px"),
            ...
            t.length && o.bind("click", function(e) {
                ...
                function(e) {
                    ...
                    l.ajax({
                        ...
                        success: function(e) {
                            "success" === e.result ? (n.removeClass("status-error").addClass("status-success").text("Thank you for subscribing. We have sent you a confirmation email."),
                            o.text(a, setTimeout(function() {
                                n.removeClass("status-success").text("")
                            }, 5e3)),
                            r.val("")) : (n.removeClass("status-success").addClass("status-error").text(e.msg.substring(4)),
                            o.text(a, setTimeout(function() {
